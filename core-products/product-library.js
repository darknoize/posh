(function initPoshProductLibrary(global) {
  ...
  const variants = [
    ...
    { name: "POS708", title: "POS-708", family: "POS", targetSlug: "pos108", pageSlug: "pos-708", detailHref: "core-products/products/pos-708.html", icons: ["POS.png"], image: "../assets/images/products/orig-pos108-top.png", description: "POS708-USB is a dual cash drawer trigger and alarm, and can also serve as a single or dual paper receipt alarm with the POS-PSen-708. Easy to install and plug-and-play as a virtual serial port or standalone device.", variables: ["708", "USB"] },
